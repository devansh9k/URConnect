...
function Feeds() {
  ...
  async function uploadImage(file, id) {
    ...
    const fileRef = ref(storage, `qanda/${id}/${file.name}`);
  ...
  //   console.log("workinggg  fdbh");
  //   e.preventDefault();

  async function handleQuestionPost(event) {
    event.preventDefault();
    var URLImage = null;
    if (imgfile) {
      URLImage = await uploadImage(imgfile, currentUser.uid);
    }
